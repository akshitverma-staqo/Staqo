...
protocol BookRoomDataSourceDelegate {
    func bookRoom(roomId:Int ,attendents:Int ,fromDateTime:String,toDateTime:String,roomStatus:String,purpose:String,visitorType: String,roomType:String,arrangementType:String,notificationId:String,roomCode:String,recurringDay:String,bookedBy:String,completion:@escaping(StaoqResult<[RoomModel]>) -> Void)
