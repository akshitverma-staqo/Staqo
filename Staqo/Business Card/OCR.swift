...
class OCR: NSObject {
    ...
    //let url = "https://www.microsoft.com/cognitive-services/en-us/computer-vision-api/ocr"
    //let url = "https://westeurope.api.cognitive.microsoft.com/vision/v1.0/ocr"
    let url = "https://oq-business-card.cognitiveservices.azure.com/vision/v1.0/ocr"
    ...
    func recognizeCharactersWithRequestObject(_ requestObject: OCRRequestObject, completion: @escaping (_ response: [String:AnyObject]? ) -> Void) throws {
        ...
        //requestObject.language.rawValue
        ...
        let task = URLSession.shared.dataTask(with: request){ data, response, error in
            if error != nil{
                ...
                do { let results = try JSONSerialization.jsonObject(with: data!, options: []) as? [String:AnyObject]
